...
%fT4B 
dydt(1) = -k1*fT4B*TBGB + k2*T4TBGB - k3*fT4B*TTRB + k4*T4TTRB - k5*fT4B*ALBB + k6*T4ALBB + (fT4T*QT + fT4RB(M)*QRB + fT4L(M)*QL - fT4B*QC)/VB;

%T4TBGB
dydt(2)	= k1*fT4B*TBGB - k2*T4TBGB + (T4TBGT*QT + T4TBGRB(M)*QRB + T4TBGL(M)*QL - T4TBGB*QC)/VB;

%T4TTRB
dydt(3) = k3*fT4B*TTRB - k4*T4TTRB + (T4TTRT*QT + T4TTRRB(M)*QRB + T4TTRL(M)*QL - T4TTRB*QC)/VB;

%T4ALBB
dydt(4) = k5*fT4B*ALBB - k6*T4ALBB + (T4ALBT*QT + T4ALBRB(M)*QRB + T4ALBL(M)*QL - T4ALBB*QC)/VB;

%fT3B
dydt(5) = -k7*fT3B*TBGB + k8*T3TBGB - k9*fT3B*TTRB + k10*T3TTRB - k11*fT3B*ALBB + k12*T3ALBB + (fT3T*QT + fT3RB(M)*QRB + fT3L(M)*QL - fT3B*QC)/VB;

%T3TBGB
dydt(6)	= k7*fT3B*TBGB - k8*T3TBGB + (T3TBGT*QT + T3TBGRB(M)*QRB + T3TBGL(M)*QL - T3TBGB*QC)/VB;

%T3TTRB
dydt(7) = k9*fT3B*TTRB - k10*T3TTRB + (T3TTRT*QT + T3TTRRB(M)*QRB + T3TTRL(M)*QL - T3TTRB*QC)/VB;

%T3ALBB
dydt(8) = k11*fT3B*ALBB - k12*T3ALBB + (T3ALBT*QT + T3ALBRB(M)*QRB + T3ALBL(M)*QL - T3ALBB*QC)/VB;

%TBGB
dydt(9) = -k1*fT4B*TBGB + k2*T4TBGB - k7*fT3B*TBGB + k8*T3TBGB - k42*XB*TBGB + k43*XTBGB + (TBGT*QT + TBGRB(M)*QRB + TBGL(M)*QL - TBGB*QC)/VB;

%TTRB
dydt(10) = -k3*fT4B*TTRB + k4*T4TTRB - k9*fT3B*TTRB + k10*T3TTRB - k38*XB*TTRB + k39*XTTRB + (TTRT*QT + TTRRB(M)*QRB + TTRL(M)*QL - TTRB*QC)/VB;

%ALBB
dydt(11) = -k5*fT4B*ALBB + k6*T4ALBB - k11*fT3B*ALBB + k12*T3ALBB + (ALBT*QT + ALBRB(M)*QRB + ALBL(M)*QL - ALBB*QC)/VB;
...
D = 0;  %Diffusion constant in tissue blood. Use 1E7 if diffusion in blood is needed. 
